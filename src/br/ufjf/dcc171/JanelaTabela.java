...
public class JanelaTabela extends JFrame {
    ...
    public JanelaTabela() throws HeadlessException {
        super("Tabelas 01");
        Object[][] dados = new Object[][]{{"Fulano", "18", "fulano@domain.com"},
        {"Beltrano", "19", "beltrano@domain.com"},
        {"Ciclano", "20", "ciclano@domain.com"}};
        Object[] titulos = new Object[]{"Nome", "Idade", "Email"};
